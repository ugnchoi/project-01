    ...
    <div className="space-y-8">
      ...
      <section className="text-center py-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          provide the best development experience and user interface.
        </p>
      </section>
      ...
      <section className="py-8">
        <Card title="Our Mission" className="mb-8">
          <p className="text-gray-700 leading-relaxed">
            We believe in creating web applications that are not only functional
            but also beautiful and accessible. Our mission is to provide
            developers with a solid foundation that follows modern best
            practices and enables rapid development of scalable applications.
          </p>
        </Card>
      </section>
